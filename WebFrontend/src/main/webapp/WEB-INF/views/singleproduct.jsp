...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-8">
			...
			<h4>
				Price: <strong><i class="fa fa-inr" aria-hidden="true"></i>
			...
			<c:choose>
				...
				<c:otherwise>
					...
					<form action="cartadd${product.id}">
						<label><h4>Quantity</h4></label> <input type="number" name=quant
							value="1" style="width: 50px;"> <br />
						<br />
			...
			<a href="${contextRoot}/allproduct" class="btn btn-primary"> Back</a>
		</div>
